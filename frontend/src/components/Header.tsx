...
export const Header: React.FC = () => {
    ...
    return (
        <header className="w-full bg-blue-dark border-b border-white/10 sticky top-0 z-50">
            ...
            <nav className="relative max-w-7xl mx-auto px-4 lg:px-8 flex items-center justify-between h-16 gap-4 lg:gap-8">
                <Link to="/" className="font-bold text-lg text-white tracking-tight shrink-0 truncate max-w-[65vw] lg:max-w-none">
                ...
                <div className="flex items-center gap-3 shrink-0">
                        ...
                        <>
                            ...
                            {isAdmin && (
                                <button
                                    ...
                                    className="hidden lg:inline-flex items-center justify-center px-4 h-9 rounded bg-blue-accent hover:bg-blue-accent/80 text-white text-xs font-semibold tracking-wide transition-colors cursor-pointer">
                                    Painel ADM
                                </button>
                            )}
                            {isVagoneteiro && (
                                <button
                                    ...
                                    className="hidden lg:inline-flex items-center gap-1.5 justify-center px-4 h-9 rounded bg-blue-accent hover:bg-blue-accent/80 text-white text-xs font-semibold tracking-wide transition-colors cursor-pointer">
                                    <Train size={14} />
                                    Feed do Vagoneteiro
                                </button>
                            )}
                            <button
                                ...
                                className="hidden lg:inline-flex items-center justify-center px-5 h-9 rounded bg-red-dark hover:bg-red-hover text-white text-sm font-semibold tracking-wide transition-colors cursor-pointer">
                                Sair
                            </button>
                        </>
                    ) : (
                    ...
                    <button
                        className="lg:hidden flex items-center justify-center w-9 h-9 text-white/60 hover:text-white transition-colors cursor-pointer"
